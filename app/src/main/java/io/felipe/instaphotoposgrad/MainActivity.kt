package io.felipe.instaphotoposgrad
...
class MainActivity : AppCompatActivity() {
    ...
    private val REQUEST_CAMERA_INTENT: Int = 1
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        fab.setOnClickListener { view ->
            startActivityForResult(Intent(MediaStore.ACTION_IMAGE_CAPTURE), REQUEST_CAMERA_INTENT)
        }
    }
    ...
    override fun onActivityResult(requestCode: Int, resultCode: Int, data: Intent?) {
        ...
        if (requestCode == REQUEST_CAMERA_INTENT && resultCode == RESULT_OK) {
            ...
            imgv_photo.setImageBitmap(imageBitmap)
        } else {
